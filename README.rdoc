...
* Original Source: http://github.com/rfs/validates_cpf_cnpj
* New source:   http://github.com/thiagolima86/validates_cpf_cnpj
...
As gem:
  ...
  # in Gemfile
  gem 'validates_cpf_cnpj', :git => 'http://github.com/thiagolima86/validates_cpf_cnpj'
...
== Contributor
* {Thiago Lima}[http://github.com/thiagolima86]
